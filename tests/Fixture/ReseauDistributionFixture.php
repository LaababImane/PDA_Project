...
/**
 * ReseauDistributionFixture
 */
class ReseauDistributionFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'reseau_distribution';
    /**
     * Fields
     *
     * @var array
    ...
    public $fields = [
        ...
        'Fichier' => ['type' => 'binary', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        '_constraints' => [
